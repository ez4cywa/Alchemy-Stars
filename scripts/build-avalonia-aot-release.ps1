...
$publishDirectory = [System.IO.Path]::GetFullPath((Join-Path $repositoryRoot 'output\avalonia-aot-rf5'))
...
$rootFiles = @(
    ...
    @{ Source = 'docs\releases\1.3.0-rf.5.zh-CN.md'; Target = 'Docs\RELEASE-NOTES.zh-CN.md' },
    ...
    @{ Source = 'docs\ravenfield-adapter-validation.md'; Target = 'Docs\ravenfield-adapter-validation.md' },
...
try {
    ...
    foreach ($required in @('Converters/ravenfield_animation.py', 'Converters/ravenfield_contact.py', 'Converters/ravenfield_shape.py', 'Converters/ravenfield_weapon_contact.py', 'Tools/UnityEditor/UnityRavenfieldClipSetup.cs')) {
