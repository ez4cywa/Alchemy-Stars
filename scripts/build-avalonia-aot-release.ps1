...
$version = '1.3.0-preview.18'
$repositoryRoot = (Resolve-Path -LiteralPath (Join-Path $PSScriptRoot '..')).Path
$releaseRoot = [System.IO.Path]::GetFullPath((Join-Path $repositoryRoot 'release'))
$publishDirectory = [System.IO.Path]::GetFullPath((Join-Path $repositoryRoot 'output\avalonia-aot-preview18'))
...
$rootFiles = @(
    ...
    @{ Source = 'docs\releases\1.3.0-preview.18.zh-CN.md'; Target = 'Docs\RELEASE-NOTES.zh-CN.md' },
