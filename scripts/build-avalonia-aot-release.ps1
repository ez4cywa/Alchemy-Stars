...
$publishDirectory = [System.IO.Path]::GetFullPath((Join-Path $repositoryRoot 'output\avalonia-aot-rf2'))
...
$rootFiles = @(
    ...
    @{ Source = 'docs\releases\1.3.0-rf.2.zh-CN.md'; Target = 'Docs\RELEASE-NOTES.zh-CN.md' },
...
try {
    ...
    foreach ($required in @('Converters/ravenfield_animation.py', 'Tools/UnityEditor/UnityRavenfieldClipSetup.cs')) {
