...
$publishDirectory = [System.IO.Path]::GetFullPath((Join-Path $repositoryRoot 'output\avalonia-aot-rf1'))
...
$rootFiles = @(
    ...
    @{ Source = 'docs\releases\1.3.0-rf.1.zh-CN.md'; Target = 'Docs\RELEASE-NOTES.zh-CN.md' },
