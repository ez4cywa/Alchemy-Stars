...
This guide applies to source revision `1.3.0-preview.12` on the test branch. The latest packaged preview remains `1.3.0-preview.11`; WPF v1.1.9 remains the supported release until .NET 11 GA.
