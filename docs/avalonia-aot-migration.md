...
Version: `1.3.0-preview.18` (Native AOT preview)
...
```powershell
./output/avalonia-aot-preview18/AlchemyStars.Avalonia.exe --project-smoke ./fork/AlchemyStars/Example/Hawk/HawkSprint.aprj <output-folder>
```
