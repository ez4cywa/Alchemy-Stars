...
Version: `1.3.0-preview.24` (Native AOT preview)
...
```powershell
./output/avalonia-aot-preview24/AlchemyStars.Avalonia.exe --project-smoke ./fork/AlchemyStars/Example/Hawk/HawkSprint.aprj <output-folder>
```
