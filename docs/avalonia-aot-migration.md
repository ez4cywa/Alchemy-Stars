...
Version: `1.3.0-preview.12` (source-only; latest packaged preview: `1.3.0-preview.11`)
...
```powershell
./output/avalonia-aot-preview12/AlchemyStars.Avalonia.exe --project-smoke ./fork/AlchemyStars/Example/Hawk/HawkSprint.aprj <output-folder>
```
