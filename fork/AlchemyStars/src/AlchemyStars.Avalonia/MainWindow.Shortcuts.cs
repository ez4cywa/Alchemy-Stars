...
public sealed partial class MainWindow
{
    ...
    private void InitializeShortcuts()
    {
        ...
        Bind("Ctrl+E", ViewModel.ExportAsync, () => ViewModel.IsAnimationsPage || ViewModel.IsDualPage || ViewModel.IsRavenfieldPage && ViewModel.CanGenerateRavenfield);
        ...
        Bind("Ctrl+I", () => ViewModel.IsModelPartsPage ? ViewModel.AddPartsAsync() : ViewModel.AddAnimationsAsync(),
            () => ViewModel.IsAnimationsPage || ViewModel.IsModelPartsPage || ViewModel.IsRavenfieldPage);
        ...
        Bind("F5", () => ViewModel.IsDualPage ? ViewModel.ProcessDualAsync(true) : ViewModel.BuildPreviewAsync(),
            () => ViewModel.IsRavenfieldPage ? ViewModel.HasRavenfieldResult : ViewModel.IsDualPage ? ViewModel.HasSelectedDual : ViewModel.IsAnimationsPage && ViewModel.HasSelectedAnimation);
        ...
        Bind("Ctrl+D6", () => Run(() => ViewModel.SelectPage(WorkspacePage.Ravenfield)));
