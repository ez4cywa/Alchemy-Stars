...
public sealed class AppIcon : Control
{
    ...
    private static readonly IReadOnlyDictionary<string, Geometry> Symbols = new Dictionary<string, string>
    {
        ...
        ["cod-weapon-database"] = "M4.5 6.5V17.5A7.5 2.8 0 0 0 19.5 17.5V6.5 M4.5 10.3A7.5 2.8 0 0 0 19.5 10.3 M4.5 14.1A7.5 2.8 0 0 0 19.5 14.1 M4.5 6.5A7.5 2.8 0 1 0 19.5 6.5A7.5 2.8 0 1 0 4.5 6.5Z",
